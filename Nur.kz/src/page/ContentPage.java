	...
	public WebElement Karaoke;
	 ...
	 public WebElement KazahVers;  
	   ...
	   isElementPresent(Facebook);
				...
				Reporter.log("FAILED: by no such element error on page "+errorUrl);
	 ...
	 //Play music test
	   ...
	   public void checkAlbums () throws Exception {
	  	 ...
	  	 if (real_numb <1) {
	  		 ...
	  		 log("FAILED: by no albums on page "+errorPage);
	  		 Reporter.log("FAILED: by no albums on page "+errorPage);
	  		 throw new NullPointerException();
	  	 }
	   }
 }
